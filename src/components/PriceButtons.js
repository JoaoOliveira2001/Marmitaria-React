  ...
  if (prices.length === 1) {
    ...
    return (
      <button
        ...
        className="bg-[#5d3d29] hover:bg-[#704027] text-white px-6 py-2 rounded-full transition-colors"
      >
        Adicionar
      </button>
    );
    ...
    <div className="flex gap-2">
      {prices.map((val, idx) => (
        <button
          ...
          className="bg-[#5d3d29] hover:bg-[#704027] text-white px-4 py-2 rounded-full transition-colors"
        >
